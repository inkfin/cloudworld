...
assert(await page.evaluate(()=>document.querySelector('dialog').open),'help opens');await page.keyboard.press('Escape');
assert(await page.evaluate(()=>!document.querySelector('dialog').open),'help closes');
